function [ x2aligned, y2aligned, x2shiftMean ] = DynamicAlignXCResamp( y1, y2, frameWidth, frameStep, alignRange, interpMethod, plotGraphs)
%DYNAMICALIGNXCRESAMP Aligns a signal y2 to signal y1 by cross-correlating (XC) frames of y2, across all of y1. Outputs x and y values resampled to align with y1.
...
%
% If you just want the x shift values for y2 data, use DynamicAlignXC instead
